...
def plot_1():
    df_u0 = pd.read_csv("u0_day30_to_day90_results.csv")
    df_u1 = pd.read_csv("u1_day30_to_day90_results.csv")
    plt.figure(figsize=(12, 6))
    plt.plot(df_u0["Time"], df_u0["Indoor_Temperature"], color='g', label=r"$u_{hp}=0$")
    plt.plot(df_u1["Time"], df_u1["Indoor_Temperature"], color='b', label=r"$u_{hp}=1$")
